...
$settingsInfo = array(
    ...
    'use_local_preview' => array(
        'type' => 'checkbox',
        'title' => 'Не использовать глобальные настройки эскизов инображений',
        'description' => 'Если включено, то используются настройки эскизов, расположенные под этим параметром.',
        'value' => '1',
        'checked' => '1',
    ),
    'use_preview' => array(
