...
Class UsersModule extends Module {
        ...
        public function add_form($key = null) {
                ...
                $markers['full_name'] = (!empty($data['full_name'])) ? $data['full_name'] : '';
        ...
        public function add() {
                ...
                if (!empty($full_name) and !$valobj->cha_val($full_name, V_FULLNAME))
                    $error = $error . '<li>' . __('Wrong chars in field "full_name"') . '</li>' . "\n";
                ...
                if (!empty($error)) {
                        $_SESSION['FpsForm'] = array_merge(array('login' => null, 'full_name' => null, 'email' => null, 'timezone' => null, 'icq' => null, 'url' => null, 'about' => null, 'signature' => null, 'pol' => $pol, 'telephone' => null, 'city' => null, 'jabber' => null, 'byear' => null, 'bmonth' => null, 'bday' => null), $_POST);
